var GameGui = function () {
  ...
  GameGui.prototype.play8BallClicked = function () { //finally start the game
...
GameGui.prototype.updateTurn = function(str) {  //update turn
  ...
  GameGui.prototype.updateBalls = function(ballArr, p1side, p2side) {  //update which player uses solid's and stripes
